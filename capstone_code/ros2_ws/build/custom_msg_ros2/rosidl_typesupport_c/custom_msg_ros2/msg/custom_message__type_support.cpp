...
#include "custom_msg_ros2/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CustomMessage_type_support_symbol_names_t _CustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, custom_msg_ros2, msg, CustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg_ros2, msg, CustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msg_ros2, msg, CustomMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_custom_msg_ros2
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_msg_ros2, msg, CustomMessage)() {
  return &::custom_msg_ros2::msg::rosidl_typesupport_c::CustomMessage_message_type_support_handle;
}
