...
{
  new (message_memory) custom_msg_ros2::msg::CustomMessage(_init);
}

void CustomMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg_ros2::msg::CustomMessage *>(message_memory);
  typed_message->~CustomMessage();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMessage_message_member_array[1] = {
  {
    "custom_value",  // name
    ...
    offsetof(custom_msg_ros2::msg::CustomMessage, custom_value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMessage_message_members = {
  "custom_msg_ros2::msg",  // message namespace
  "CustomMessage",  // message name
  1,  // number of fields
  sizeof(custom_msg_ros2::msg::CustomMessage),
...
{
  return &::custom_msg_ros2::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_ros2, msg, CustomMessage)() {
  return &::custom_msg_ros2::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
