...
class Metaclass_CustomMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('custom_msg_ros2')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'custom_msg_ros2.msg.CustomMessage')
            logger.debug(
...
class CustomMessage(metaclass=Metaclass_CustomMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.custom_value = kwargs.get('custom_value', float())
    ...
    def custom_value(self, value):
        if __debug__:
            assert \
                ...
                "The 'custom_value' field must be of type 'float'"
